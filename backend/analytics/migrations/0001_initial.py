# Generated by Django 3.1.4 on 2022-03-26 18:27
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('system_name', models.CharField(blank=True, default=None, max_length=1000, null=True)),
                ('brand', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analytics.brand')),
                ('type', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analytics.producttype')),
                ('vendor', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analytics.vendor')),
            ],
        ),
        migrations.CreateModel(
            name='Order',
            fields=[
                ...
                ('inventory', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analytics.inventory')),
        ...
        migrations.AddField(
            model_name='inventory',
            name='vendor',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='analytics.vendor'),
        ),
    ]
